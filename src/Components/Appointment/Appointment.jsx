          ...
          <section id="appointment" className={styles.appointment}>
            <div className={styles.container}>
              <TemplateTitle
                ...
                width={145}
                height={14}
                alt="Faça um agendamento"
              />

              <form
                className={styles.form}
                action="https://formsubmit.co/matheus.carvalh0.job@gmail.com"
                method="POST"
              >
                <div className={styles.personalData}>
                  ...
                  <div className={styles.inputWrapper}>
                    ...
                    <select name="servico" required>
                      ...
                      <option value="cabelo padrao e barba">
                        Corte padrão e fazer a barba
                      </option>
                      <option value="corte estilizado e barba ">
                        Corte estilizado e barba
                      </option>
                      <option value="relaxamento no cabelo">
                        Fazer relaxamento no cabelo
                      </option>
                    </select>
                  </div>
                </div>
                <div className={styles.inputWrapper}>
                  ...
                  <textarea
                    placeholder="Digite detalhes do corte ou horário que deseja cortar"
                    name="mensagem"
                    required
                    autoComplete="off"
                  ></textarea>
